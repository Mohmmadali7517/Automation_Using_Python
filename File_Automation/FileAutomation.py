...
def main():
    print("---- File Automation using python ----")
    ...
    if (argv[1] == "-h") or (argv[1] == "-H"):
        print("This Script accepts 4 arguments from command line")
        exit()

    if (argv[1] == "-u") or (argv[1] == "-U"):
        print("usage : ApplicationName AbsolutePath_of_Directory User_Mail_Id Password reciever_mail_id")
        exit()
